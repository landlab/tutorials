...
This tutorial loosely follows the fault throw experiment in Lyons et
al., in preperation for Earth Surface Dynamics.

    Import modules.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{from} \PY{n+nn}{landlab} \PY{k}{import} \PY{n}{RasterModelGrid}\PY{p}{,} \PY{n}{CLOSED\PYZus{}BOUNDARY}\PY{p}{,} \PY{n}{FIXED\PYZus{}VALUE\PYZus{}BOUNDARY}
        \PY{k+kn}{from} \PY{n+nn}{landlab}\PY{n+nn}{.}\PY{n+nn}{components} \PY{k}{import} \PY{p}{(}\PY{n}{BiotaEvolver}\PY{p}{,} \PY{n}{FastscapeEroder}\PY{p}{,} \PY{n}{FlowRouter}\PY{p}{,}
                                        \PY{n}{LinearDiffuser}\PY{p}{,} \PY{n}{NormalFault}\PY{p}{)}
...
The clades of the first 26 species are labeled alphabetically A thru Z.
The next 26 are labeled AB thru AZ.

1-26: A thru Z 27-53: AA thru AZ BA thru BZ ... AAA thru AAZ ABA thru
ABZ ACA thru ACZ
...
species, B0 exists in clade B because no child species were produced by
B0.
